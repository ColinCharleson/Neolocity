...
public class SoundManager : MonoBehaviour
{
    ...
    public AudioSource walkSource, runSoruce, glideSource, wallRunningSource, ladderSource, boostSource, fallDamageSource, chompAttackSource, attackHitSource, explosionSource, rollingSource, outOfBreathSource, blockingSource;
    ...
    private void Start()
    {
        ...
        outOfBreathSource.volume = sfxVolume;
        blockingSource.volume = sfxVolume;
